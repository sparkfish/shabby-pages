...
\begin{figure}
\centering
\includegraphics[width=0.98\columnwidth, frame]{figures/quad.png}
...
These datasets are listed in Table~\ref{tab:datasets}.
%By now, hundreds of datasets exist for the document denoising task (several listed in \cite{tab:datasets}), 
...
\ubsubsection{Developing the Pipeline.}
...
\begin{table}[]
    ...
    \textbf{Training Set~~} & \textbf{Test Set} & \textbf{Model} & \textbf{SSIM$\uparrow$~}\\
        \midrule
        \textsf{ShabbyPages} & \textsf{NoisyOffice-real} & NAFNet & \textbf{0.96}\\
        \textsf{NoisyOffice-sim} & \textsf{ShabbyPages} & NAFNet & 0.83\\
        \bottomrule
    \end{tabular}}
\end{table}
...
\begin{table}[]
    ...
    \textbf{Training Set~~} & \textbf{Test Set} & \textbf{Model} & \textbf{SSIM$\uparrow$~} & \textbf{PSNR$\uparrow$~} & \textbf{RMSE$\downarrow$~}\\
        \midrule
        \textsf{ShabbyPages} & \textsf{NoisyOffice-real} & NAFNet & \textbf{0.947} & \textbf{38.098} & \textbf{3.205}\\
        \textsf{NoisyOffice-sim} & \textsf{ShabbyPages} & NAFNet & 0.811 & 34.562 & 5.384\\
        \bottomrule
    \end{tabular}}
