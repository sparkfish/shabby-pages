...
\begin{table}[]
    ...
    \begin{tabular}{llll}
    \toprule
    \textbf{Training Set} & \textbf{Test Set} & \textbf{SSIM} & \textbf{RMSE} & \textbf{PSNR} \\
        \midrule
        \textsf{ShabbyPages} & \textsf{ShabbyPages} & \textsf{0.9255905809319086} & \textsf{2.987994328426575} & \textsf{39.29266235129017}\\
        \textsf{SimulatedNoisyOffice} & \textsf{RealNoisyOffice} & \textsf{0.9866020337197627} & \textsf{3.8045857559449296} & \textsf{36.73658388839052}\\
        \textsf{ShabbyPages} & \textsf{RealNoisyOffice} & \textsf{0.9465069385860134} & \textsf{3.2046770685272117} & \textsf{38.097843772060855}\\
        \textsf{SimulatedNoisyOffice} & \textsf{ShabbyPages} & \textsf{0.8105023745816482} & \textsf{5.38408321532059} & \textsf{34.56195157529838}\\
        \bottomrule
    \end{tabular}}
